...
int playMime(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
{
    int i = 0;
    int j = 0;
    handPos = 0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case feast:
      ...
      return playFeast(currentPlayer, state, choice2);
    ...
    case mine:
      ...
      return playMime(currentPlayer, state, choice1, choice2, handPos);
